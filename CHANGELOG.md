...
## [Pinned Profile Slots + Multi-Build Discovery] - 2026-02-20

- Added a new **Manage Pinned Profiles** command to discover and pin profiles from Stable, Dev, Beta, and Canary builds
- Added 5 dedicated root-search commands: **Open Pinned Profile 1-5**
- Added best-effort window reuse when opening pinned profiles, with fallback to launching a profile-specific window
- Added "Open in pinned profile" actions for history/bookmark/collection entries
- Documented Raycast static-command limitations and Edge profile automation constraints
